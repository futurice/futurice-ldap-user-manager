...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SSHKey'
        db.create_table(u'fum_sshkey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('key', self.gf('django.db.models.fields.TextField')()),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fum.Users'])),
            ('fingerprint', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, db_index=True)),
            ('bits', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'fum', ['SSHKey'])


    def backwards(self, orm):
        # Deleting model 'SSHKey'
        db.delete_table(u'fum_sshkey')
    ...
    models = {
        ...
        u'fum.sshkey': {
            ...
            'fingerprint': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '100', 'db_index': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.TextField', [], {}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fum.Users']"})
        },
        u'fum.users': {
            ...
            'shadow_last_change': ('django.db.models.fields.IntegerField', [], {'default': '16437', 'null': 'True', 'blank': 'True'}),
            'shadow_max': ('django.db.models.fields.IntegerField', [], {'default': '367', 'null': 'True', 'blank': 'True'}),
