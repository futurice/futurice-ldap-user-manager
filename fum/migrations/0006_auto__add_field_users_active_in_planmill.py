...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Users.active_in_planmill'
        db.add_column(u'fum_users', 'active_in_planmill',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Users.active_in_planmill'
        db.delete_column(u'fum_users', 'active_in_planmill')
    ...
    models = {
        ...
        u'fum.users': {
            ...
            'active_in_planmill': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
            ...
            'shadow_last_change': ('django.db.models.fields.IntegerField', [], {'default': '16134', 'null': 'True', 'blank': 'True'}),
