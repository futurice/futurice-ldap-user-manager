...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Users.google_status'
        db.alter_column(u'fum_users', 'google_status', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Users.google_status'
        db.alter_column(u'fum_users', 'google_status', self.gf('django.db.models.fields.CharField')(max_length=1))
    ...
    models = {
        ...
        u'fum.users': {
            ...
            'shadow_last_change': ('django.db.models.fields.IntegerField', [], {'default': '16009', 'null': 'True', 'blank': 'True'}),
