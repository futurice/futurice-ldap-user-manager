...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Users.created'
        db.add_column(u'fum_users', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Users.created'
        db.delete_column(u'fum_users', 'created')
    ...
    models = {
        ...
        u'fum.users': {
            ...
            'shadow_last_change': ('django.db.models.fields.IntegerField', [], {'default': '16006', 'null': 'True', 'blank': 'True'}),
