...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Users.active_in_planmill'
        if 'postgres' in settings.DATABASES['default']['ENGINE']:
            db.execute("""
            ALTER TABLE "fum_users"
                ALTER COLUMN "active_in_planmill" DROP DEFAULT,
                ALTER COLUMN "active_in_planmill" SET NOT NULL,
                ALTER COLUMN "active_in_planmill" TYPE integer USING CASE WHEN active_in_planmill=TRUE THEN 1 ELSE 0 END,
                ALTER COLUMN "active_in_planmill" SET DEFAULT 0;
            """)
        else:
            db.alter_column(u'fum_users', 'active_in_planmill', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Users.active_in_planmill'
        db.alter_column(u'fum_users', 'active_in_planmill', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'fum.users': {
            ...
            'active_in_planmill_tmp': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'content_type': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contenttypes.ContentType']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'null': 'True', 'blank': 'True'}),
