...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Users.hr_number'
        db.add_column(u'fum_users', 'hr_number',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Users.hr_number'
        db.delete_column(u'fum_users', 'hr_number')
    ...
    models = {
        ...
        u'fum.users': {
            ...
            'shadow_last_change': ('django.db.models.fields.IntegerField', [], {'default': '16015', 'null': 'True', 'blank': 'True'}),
