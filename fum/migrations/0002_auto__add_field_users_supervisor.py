...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Users.supervisor'
        db.add_column(u'fum_users', 'supervisor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fum.Users'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Users.supervisor'
        db.delete_column(u'fum_users', 'supervisor_id')
